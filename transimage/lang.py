# This file is part of Transimage.

# Transimage is free software: you can redistribute it and/or modify
# it under the terms of the GNU General Public License as published by
# the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.

# Transimage is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
# GNU General Public License for more details.

# You should have received a copy of the GNU General Public License
# along with Transimage. If not, see <https://www.gnu.org/licenses/>.
...
ALL_LANG_DICT={
    ...
    'aze_cyrl': 'azerbaijani cyrillic', #Azerbaijani (cyrillic) 
    #'bih': 'bihari',                   #Bihari      
    ...
    'eng': 'english',                       #English
    #'enm': 'english (old)',                #English (middle)
    ...
    #'kat_old': 'georgian (old)',           #Georgian (old)
    'kaz': 'kazakh',                        #Kazakh
    #'kdb': 'kavardian',                    #Kabardian
    'khm': 'khmer',                         #Khmer
    #'kir': 'kirghz',                       #Kirghiz 
    'kmr': 'kurdish',                       #Kurdish (northerm)
    'kor': 'korean',                        #Korean
    'kor_vert': 'korean (vertical)',        #Korean (vertical)
    'lao': 'lao',                           #Lao
    'lat': 'latin',                         #Latin
    'lav': 'latvian',                       #Latvian
    #'lbe': 'lak',                          #Lak
    ...
    #'mah': 'magahi',                       #Magahi
    'mal': 'malayalem',                     #Malayalam
    'mar': 'marathi',                       #Marathi 
    'mkd': 'macedonian',                    #Macedonian 
    'mlt': 'maltese',                       #Maltese 
    'mon': 'mongalian',                     #Mongolian 
    'mri': 'maori',                         #Maori 
    'msa': 'malay',                         #Malay 
    'mya': 'burmese',                       #Burmese 
    'nep': 'nepali',                        #Nepali 
    ...
    'snd': 'sindhi',                        #Sindhi 
    'spa': 'spanish',                       #Spanish 
    #'spa_old': 'spanish (old)',            #Spanish (old)
    'sqi': 'albanian',                      #Albanian 
    'srp': 'serbian (cyrillic)',            #Serbian (cyrillic)
    'srp_latn': 'serbian (latin)',          #Serbian (latin)
    ...
    'urd': 'urdu',                          #Urdu
    'uzb': 'uzbek',                         #Uzbek
    'urb_cyrl': 'uzbek (cyrillic)',         #Uzbek (cyrillic)
